...
class RafFormSubmission extends Model
{
    use HasFactory;
    ...
    // Relationships
    public function rafForm(): BelongsTo
    {
        return $this->belongsTo(RemittanceApplicationForm::class, 'raf_form_id');
    }
    ...
    {
        return $query->where('raf_form_id', $formId);
    }
