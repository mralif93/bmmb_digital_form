...
class StateController extends Controller
{
    ...
    /**
     * Resync states from MAP database.
     */
    public function resync()
    {
        try {
            \Illuminate\Support\Facades\Artisan::call('map:migrate-states');

            return redirect()->back()->with('success', 'State synchronization completed successfully.');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Failed to sync states: ' . $e->getMessage());
        }
    }
