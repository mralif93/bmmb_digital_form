...
@section('title', 'Data Correction Request Form - BMMB Digital Forms')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="text-lg text-white/90 mb-6 max-w-2xl mx-auto">
                Request corrections to your personal data and ensure accuracy of your information.
            </p>
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="form-card rounded-xl p-8 shadow-xl" x-data="{ currentStep: 1 }">
                ...
                <div class="flex items-center justify-between relative">
                    ...
                    <div class="flex items-center relative z-10 group cursor-pointer" @click="currentStep = 2">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold shadow-lg transition-all duration-300"
                            ...
                            <i class='bx bx-edit text-lg' x-show="currentStep > 2" x-cloak></i>
                            <span x-show="currentStep <= 2" x-cloak>2</span>
                        </div>
                        <div class="ml-3">
                            <span class="text-sm font-semibold block"
                                  :class="currentStep >= 2 ? 'text-blue-600' : 'text-gray-500'">Correction Details</span>
                    ...
                    <div class="flex items-center relative z-10 group cursor-pointer" @click="currentStep = 3">
                        <div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold shadow-lg transition-all duration-300"
                            ...
                            <i class='bx bx-paperclip text-lg' x-show="currentStep > 3" x-cloak></i>
                            <span x-show="currentStep <= 3" x-cloak>3</span>
                        </div>
                        <div class="ml-3">
                            <span class="text-sm font-semibold block"
                                  :class="currentStep >= 3 ? 'text-blue-600' : 'text-gray-500'">Supporting Documents</span>
            ...
            <!-- Form -->
            <form id="dcr-form" class="space-y-8">
                @csrf
                ...
                <div x-show="currentStep === 2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="correction_type" class="block text-sm font-medium text-gray-700 mb-2">
                                Correction Type <span class="text-red-500">*</span>
                            </label>
                            <select id="correction_type" name="correction_type" required
                                    class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                ...
                                <option value="address_info">Address Information</option>
                    ...
                    <div class="mt-6">
                        <label for="incorrect_data_description" class="block text-sm font-medium text-gray-700 mb-2">
                            Incorrect Data Description <span class="text-red-500">*</span>
                        </label>
                        <textarea id="incorrect_data_description" name="incorrect_data_description" rows="4" required
                                  placeholder="Please describe the incorrect data that needs to be corrected..."
                                  class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                    </div>
                    
                    <div class="mt-6">
                        <label for="incorrect_data_location" class="block text-sm font-medium text-gray-700 mb-2">
                            Incorrect Data Location <span class="text-red-500">*</span>
                        </label>
                        <input type="text" id="incorrect_data_location" name="incorrect_data_location" required
                               placeholder="e.g., Database table, System name, File location"
                               class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    </div>
                    
                    <div class="mt-6">
                        <label for="incorrect_data_fields" class="block text-sm font-medium text-gray-700 mb-2">
                            Incorrect Data Fields <span class="text-red-500">*</span>
                        </label>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            <label class="flex items-center">
                                <input type="checkbox" name="incorrect_data_fields[]" value="name" class="mr-2">
                                <span class="text-sm">Name</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="incorrect_data_fields[]" value="email" class="mr-2">
                                <span class="text-sm">Email</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="incorrect_data_fields[]" value="phone" class="mr-2">
                                <span class="text-sm">Phone</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="incorrect_data_fields[]" value="address" class="mr-2">
                                <span class="text-sm">Address</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="incorrect_data_fields[]" value="date_of_birth" class="mr-2">
                                <span class="text-sm">Date of Birth</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="incorrect_data_fields[]" value="other" class="mr-2">
                    ...
                    <div class="mt-6">
                        <label for="correct_data_description" class="block text-sm font-medium text-gray-700 mb-2">
                            Correct Data Description <span class="text-red-500">*</span>
                        </label>
                        <textarea id="correct_data_description" name="correct_data_description" rows="4" required
                                  placeholder="Please describe the correct data that should replace the incorrect data..."
                                  class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                    </div>
                    
                    <div class="mt-6">
                        <label for="correct_data_fields" class="block text-sm font-medium text-gray-700 mb-2">
                            Correct Data Fields <span class="text-red-500">*</span>
                        </label>
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            <label class="flex items-center">
                                <input type="checkbox" name="correct_data_fields[]" value="name" class="mr-2">
                                <span class="text-sm">Name</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="correct_data_fields[]" value="email" class="mr-2">
                                <span class="text-sm">Email</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="correct_data_fields[]" value="phone" class="mr-2">
                                <span class="text-sm">Phone</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="correct_data_fields[]" value="address" class="mr-2">
                                <span class="text-sm">Address</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="correct_data_fields[]" value="date_of_birth" class="mr-2">
                                <span class="text-sm">Date of Birth</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="correct_data_fields[]" value="other" class="mr-2">
                                <span class="text-sm">Other</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        <label for="correction_justification" class="block text-sm font-medium text-gray-700 mb-2">
                            Correction Justification <span class="text-red-500">*</span>
                        </label>
                        <textarea id="correction_justification" name="correction_justification" rows="4" required
                                  placeholder="Please provide justification for the correction request..."
                                  class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                    </div>
                ...
                <div x-show="currentStep === 3" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="supporting_documents[]" value="id_document" class="mr-2">
                                <span class="text-sm">ID Document</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="supporting_documents[]" value="proof_of_address" class="mr-2">
                                <span class="text-sm">Proof of Address</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="supporting_documents[]" value="birth_certificate" class="mr-2">
                                <span class="text-sm">Birth Certificate</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="supporting_documents[]" value="marriage_certificate" class="mr-2">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="legal_basis_description" name="legal_basis_description" rows="3" required
                                  placeholder="Please provide details about the legal basis for your correction request..."
                                  class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                    </div>
                ...
                <div x-show="currentStep === 4" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-x-4" x-transition:enter-end="opacity-100 transform translate-x-0">
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 mb-6">
                        <h4 class="text-lg font-semibold text-gray-900 mb-4">Correction Details</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div><strong>Correction Type:</strong> <span id="review_correction_type">-</span></div>
                            ...
                            <div><strong>Incorrect Data Location:</strong> <span id="review_incorrect_data_location">-</span></div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between mt-8">
                        ...
                        <button type="submit" onclick="submitForm('dcr-form', 'Data correction request submitted successfully!')" 
                                class="btn-primary text-white px-8 py-3 rounded-lg font-semibold">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                Your right to data accuracy and our commitment to data correction.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Data Accuracy</h3>
                <p class="text-gray-600">
                    We are committed to maintaining accurate and up-to-date personal data.
                </p>
            </div>
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">
                    We will process your correction request within 30 days as required by law.
                </p>
            </div>
...
<script>
    ...
    function updateReview() {
        ...
        document.getElementById('review_correction_type').textContent = document.getElementById('correction_type').value || '-';
        ...
        document.getElementById('review_incorrect_data_location').textContent = document.getElementById('incorrect_data_location').value || '-';
