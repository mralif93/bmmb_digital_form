    ...
    <div class="max-w-md w-full space-y-8 text-center">
        <div>
            <div class="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <i class='bx bx-error-circle text-red-600 text-4xl'></i>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <a href="{{ route('home') }}" class="inline-flex items-center px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold rounded-lg transition-colors">
