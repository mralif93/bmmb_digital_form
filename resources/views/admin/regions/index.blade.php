...
@section('content')
    ...
    <div class="mb-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            ...
            <button onclick="confirmResync('{{ route('admin.regions.resync') }}')" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg transition-colors">
                ...
                Swal.fire({
                    ...
                    html: `
                            <div class="text-center">
                                ...
                                <p class="text-sm text-gray-600">This action will move the region to the trash.</p>
                            </div>
                        `,
                    icon: 'warning',
