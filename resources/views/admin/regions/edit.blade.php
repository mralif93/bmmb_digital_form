...
@section('title', 'Edit Region - BMMB Digital Forms')
...
@section('content')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <form action="{{ route('admin.regions.update', $region) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit"
                    class="px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-xs font-medium rounded-lg">Update
                    Region</button>
            </div>
        </form>
    </div>
