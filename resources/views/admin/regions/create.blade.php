...
@section('title', 'Create Region - BMMB Digital Forms')
@section('page-title', 'Create New Region')
...
@section('content')
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Region Information</h3>
        </div>
        <form action="{{ route('admin.regions.store') }}" method="POST" class="p-6">
            @csrf
            <div class="mb-4">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit"
                    class="px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white text-xs font-medium rounded-lg">Create
                    Region</button>
            </div>
        </form>
    </div>
