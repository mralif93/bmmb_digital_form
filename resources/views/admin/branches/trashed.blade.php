...
@section('title', 'Trashed Branches - BMMB Digital Forms')
@section('page-title', 'Trashed Branches')
@section('page-description', 'View and manage deleted branches')
...
@section('content')
    ...
    <div class="mb-4 flex items-center justify-between">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-sm font-semibold text-gray-900 dark:text-white">Trashed Branches</h2>
    ...
    <div class="mb-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
        <form method="GET" action="{{ route('admin.branches.trashed') }}" class="space-y-3">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-right text-xs font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <form action="{{ route('admin.branches.force-delete', $branch->id) }}" method="POST"
                                        class="inline-block"
                                        onsubmit="return confirm('Are you sure you want to permanently delete this branch? This action cannot be undone.');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center">
                                ...
                                <h4 class="text-sm font-semibold text-gray-900 dark:text-white mb-1">No trashed branches found
                                </h4>
                            </td>
                        </tr>
                    @endforelse
