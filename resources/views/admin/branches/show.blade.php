...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <dl class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <dd class="text-sm text-gray-900 dark:text-white">
                        <a href="mailto:{{ $branch->email }}" class="text-primary-600 dark:text-primary-400 hover:underline">
                            {{ $branch->email }}
                        </a>
                    </dd>
                </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="space-y-2">
                <a href="{{ route('admin.branches.edit', $branch->id) }}" class="block w-full text-center px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white text-xs font-semibold rounded-lg transition-colors">
                    <i class='bx bx-edit mr-1.5'></i>
                    Edit Branch
                </a>
                <button onclick="deleteBranch({{ $branch->id }})" class="block w-full text-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-xs font-semibold rounded-lg transition-colors">
                    <i class='bx bx-trash mr-1.5'></i>
                    Delete Branch
                </button>
            </div>
