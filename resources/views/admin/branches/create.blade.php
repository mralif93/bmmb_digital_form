                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="weekend_start_day" id="weekend_start_day" required
                            ...
                            <option value="MONDAY" {{ old('weekend_start_day') == 'MONDAY' ? 'selected' : '' }}>MONDAY
                            </option>
                            <option value="TUESDAY" {{ old('weekend_start_day') == 'TUESDAY' ? 'selected' : '' }}>TUESDAY
                            </option>
                            <option value="WEDNESDAY" {{ old('weekend_start_day') == 'WEDNESDAY' ? 'selected' : '' }}>
                                WEDNESDAY</option>
                            <option value="THURSDAY" {{ old('weekend_start_day') == 'THURSDAY' ? 'selected' : '' }}>THURSDAY
                            </option>
                            <option value="FRIDAY" {{ old('weekend_start_day') == 'FRIDAY' ? 'selected' : '' }}>FRIDAY
                            </option>
                            <option value="SATURDAY" {{ old('weekend_start_day', 'SATURDAY') == 'SATURDAY' ? 'selected' : '' }}>SATURDAY</option>
                            <option value="SUNDAY" {{ old('weekend_start_day') == 'SUNDAY' ? 'selected' : '' }}>SUNDAY
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="ti_agent_code" id="ti_agent_code" value="{{ old('ti_agent_code') }}"
                            required placeholder="e.g., FN12984"
