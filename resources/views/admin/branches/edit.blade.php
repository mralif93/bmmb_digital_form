        ...
        <form action="{{ route('admin.branches.update', $branch->id) }}" method="POST" class="p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="ti_agent_code" id="ti_agent_code" value="{{ old('ti_agent_code', $branch->ti_agent_code) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="state" id="state" value="{{ old('state', $branch->state) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="region" id="region" value="{{ old('region', $branch->region) }}" required
            ...
            <div class="flex justify-end space-x-3 mt-6">
                <a href="{{ route('admin.branches.show', $branch->id) }}" class="px-4 py-2 text-xs font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    Cancel
                </a>
