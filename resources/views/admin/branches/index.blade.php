...
@section('content')
    ...
    <div class="mb-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            <a href="{{ route('admin.branches.trashed') }}" class="inline-flex items-center px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 dark:bg-red-900/30 dark:hover:bg-red-900/50 dark:text-red-400 text-xs font-semibold rounded-lg transition-colors">
        ...
        <div class="mb-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <form method="GET" action="{{ route('admin.branches.index') }}" class="space-y-3">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                    ...
                    <div>
                        <label for="state"
                            class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">State</label>
