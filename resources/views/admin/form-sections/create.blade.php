...
@section('title', 'Create Form Section - BMMB Digital Forms')
@section('page-title', 'Create New Section')
@section('page-description', 'Add a new section for ' . ucfirst($type) . ' form')
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
    <form action="{{ route('admin.form-sections.store', $type) }}" method="POST">
        @csrf
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="section_label" id="section_label" value="{{ old('section_label') }}" required
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            ...
            <div>
                ...
                <textarea name="section_description" id="section_description" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                          placeholder="Optional description for this section">{{ old('section_description') }}</textarea>
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $maxOrder + 1) }}" min="0"
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent">
