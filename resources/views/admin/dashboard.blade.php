...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        @elseif(auth()->user()->isBM() || auth()->user()->isABM())
            <!-- BM/ABM Stats -->
            <div
                class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-100 dark:border-gray-700 hover:shadow-md transition-all duration-300">
                <div class="flex items-center justify-between">
    ...
    @if(isset($availableSubmissions) && (auth()->user()->isCFE() || auth()->user()->isOO()))
            ...
            function openCompleteModal(formSlug, submissionId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'POST';
                        form.action = `/admin/submissions/${formSlug}/${submissionId}/complete`;
