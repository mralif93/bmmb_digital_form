    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-all duration-300">
        <div class="flex items-center justify-between">
            ...
            <div class="w-12 h-12 bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30 rounded-xl flex items-center justify-center shadow-md">
                <i class='bx bx-edit-alt text-xl text-orange-600 dark:text-orange-400'></i>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex space-x-2">
                <button class="px-4 py-2 text-sm font-semibold bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-xl shadow-sm">7D</button>
        ...
        <div class="h-80 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-2xl border-2 border-dashed border-gray-300 dark:border-gray-600">
            <div class="text-center">
                <div class="w-20 h-20 bg-orange-100 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4">
                    <i class='bx bx-bar-chart-alt-2 text-4xl text-orange-600 dark:text-orange-400'></i>
                </div>
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">Your most successful forms</p>
                   ...
                   <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-2 text-sm font-semibold text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded-xl transition-colors">
                       View All
                       <i class='bx bx-right-arrow-alt ml-2'></i>
                   </a>
        </div>
        <div class="space-y-6">
            <div class="flex items-center justify-between p-6 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-2xl border border-orange-100 dark:border-orange-800/30">
                <div class="flex items-center space-x-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30 rounded-xl flex items-center justify-center shadow-lg">
                        <i class='bx bx-user-plus text-2xl text-orange-600 dark:text-orange-400'></i>
                    </div>
                    <div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="#" class="text-sm text-orange-600 dark:text-orange-400 hover:underline">View All</a>
        </div>
        <div class="space-y-4">
            <div class="flex items-start space-x-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                <div class="w-8 h-8 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center">
                    <i class='bx bx-plus text-orange-600 dark:text-orange-400 text-sm'></i>
                </div>
                <div class="flex-1">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div class="space-y-3">
            <a href="{{ route('admin.forms.create') }}" class="flex items-center p-3 bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-lg hover:bg-orange-100 dark:hover:bg-orange-900/50 transition-colors">
                <i class='bx bx-file-blank mr-3'></i>
                Create New Form
            </a>
            
            <a href="{{ route('admin.content.create') }}" class="flex items-center p-3 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors">
                <i class='bx bx-edit mr-3'></i>
                Create Content
            </a>
            
            <a href="{{ route('admin.forms.index') }}" class="flex items-center p-3 bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/50 transition-colors">
                <i class='bx bx-qr-scan mr-3'></i>
                Generate QR Codes
            </a>
            
            <a href="{{ route('admin.users.index') }}" class="flex items-center p-3 bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/50 transition-colors">
