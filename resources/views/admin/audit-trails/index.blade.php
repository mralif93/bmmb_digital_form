...
@section('content')
    ...
    <div class="mb-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
        <form method="GET" action="{{ route('admin.audit-trails.index') }}"
            ...
            <div>
                ...
                <select name="action"
                    class="w-full px-3 py-1.5 text-xs border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
            ...
            <div class="lg:col-span-5">
                <div class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('admin.audit-trails.index') }}"
                        class="px-4 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-300 text-xs font-semibold rounded-lg transition-colors">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="text-xs text-gray-900 dark:text-white">
                                    {{ $timezoneHelper->convert($auditTrail->created_at)?->format($dateFormat) }}
                                </div>
                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                    {{ $timezoneHelper->convert($auditTrail->created_at)?->format($timeFormat) }}
                                </div>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-right text-xs font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('admin.audit-trails.show', $auditTrail->id) }}"
                                        class="inline-flex items-center px-3 py-1.5 bg-blue-100 hover:bg-blue-200 text-blue-700 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 dark:text-blue-400 rounded-lg text-xs transition-colors">
                                        View
                                    </a>
                                </div>
                            </td>
