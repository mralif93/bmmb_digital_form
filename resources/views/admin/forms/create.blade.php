...
@section('page-description', 'Add a new custom form to the system')
    ...
    <form action="{{ route('admin.forms.store') }}" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input type="number" name="submission_limit" id="submission_limit" value="{{ old('submission_limit') }}" min="1"
                       class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent"
            ...
            <div class="space-y-2">
                ...
                <label class="flex items-center">
                    <input type="checkbox" name="allow_multiple_submissions" value="1" {{ old('allow_multiple_submissions', true) ? 'checked' : '' }}
                           class="rounded border-gray-300 dark:border-gray-600 text-orange-600 focus:ring-orange-500">
                    <span class="ml-2 text-xs text-gray-700 dark:text-gray-300">Allow Multiple Submissions</span>
                </label>
                <label class="flex items-start">
                    <input type="checkbox" name="show_important_note" value="1" {{ old('show_important_note', false) ? 'checked' : '' }}
            ...
            <div class="mt-6 space-y-3 border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-900/30">
                ...
                <div>
                    ...
                    <input type="text" name="important_note_title" value="{{ old('important_note_title') }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                           placeholder="Important Note">
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1">Intro Text</label>
                    <input type="text" name="important_note_intro" value="{{ old('important_note_intro') }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <textarea name="important_note_items" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                              placeholder="Enter each bullet item on a new line">{{ old('important_note_items') }}</textarea>
                </div>
                <div>
                    ...
                    <textarea name="important_note_contact" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                              placeholder="Contact information displayed below the note">{{ old('important_note_contact') }}</textarea>
                </div>
            </div>
        </div>
