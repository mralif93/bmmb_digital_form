...
@section('content')
<div class="mb-4">
    <a href="{{ route('admin.qr-codes.show', $qrCode->id) }}" class="inline-flex items-center px-3 py-2 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
