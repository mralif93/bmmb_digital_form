            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <dl class="space-y-3">
                    ...
                    <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                        ...
                        <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                            {{ $user->last_login_at ? $user->last_login_at->format($dateFormat . ' ' . $timeFormat) : 'Never' }}
                        </dd>
                    </div>
                    <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                        <dt
                        ...
                        <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                            {{ $user->created_at->format($dateFormat . ' ' . $timeFormat) }}
                        </dd>
                    </div>
                    <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                        <dt
                        ...
                        <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                            {{ $user->updated_at->format($dateFormat . ' ' . $timeFormat) }}
                        </dd>
                    </div>
                    @if($user->bio)
                        <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
