<form id="userCreateForm" action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label for="modal_create_first_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">First Name *</label>
        ...
        <div>
            <label for="modal_create_last_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Last Name *</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label for="modal_create_email" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Email Address *</label>
        ...
        <div>
            <label for="modal_create_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Phone Number</label>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label for="modal_create_password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Password *</label>
            <input type="password" name="password" id="modal_create_password" 
                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent @error('password') border-red-500 @enderror" required>
            @error('password')
                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            <label for="modal_create_password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Confirm Password *</label>
            <input type="password" name="password_confirmation" id="modal_create_password_confirmation" 
                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent" required>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            <label for="modal_create_role" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Role *</label>
        ...
        <div>
            <label for="modal_create_status" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Status *</label>
    ...
    <!-- Branch -->
    <div>
        <label for="modal_create_branch_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Branch</label>
    ...
    <!-- Bio -->
    <div>
        <label for="modal_create_bio" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Bio</label>
    ...
    <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        <button type="button" onclick="closeUserCreateModal()" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-colors">
            Cancel
        </button>
