        ...
        <div class="space-y-2">
            ...
            <div class="flex items-start gap-4">
                ...
                <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                    ...
                    @if($submission->user)
                        <span class="text-gray-500 dark:text-gray-400 text-xs block mt-1">({{ $submission->user->email }})</span>
                    @endif
                </dd>
            </div>
            ...
            <div class="flex items-start gap-4">
                ...
                <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                    ...
                    @if($submission->branch->ti_agent_code)
                        <span class="text-gray-500 dark:text-gray-400 text-xs block mt-1">({{ $submission->branch->ti_agent_code }})</span>
                    @endif
                </dd>
            </div>
            @endif
        ...
        <div class="space-y-2 max-h-64 overflow-y-auto">
            ...
            <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-2 last:border-0 gap-4">
                ...
                <dd class="text-xs text-gray-900 dark:text-white flex-1 text-left">
                    @if(is_array($value))
                        <pre class="bg-white dark:bg-gray-800 p-2 rounded text-xs overflow-x-auto">{{ json_encode($value, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
    ...
    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
        ...
        <div class="space-y-2">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">
                Reviewed by {{ $submission->reviewedBy->first_name . ' ' . $submission->reviewedBy->last_name }} on {{ $submission->reviewed_at->format('M d, Y h:i A') }}
            </p>
            @endif
        </div>
    </div>
