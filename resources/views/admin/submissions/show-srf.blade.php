...
@section('title', 'SRF Submission Details - BMMB Digital Forms')
@section('page-title', 'SRF Submission #' . $submission->id)
@section('page-description', 'View Service Request Form submission details')

@section('content')
<div class="mb-4 flex items-center justify-between">
    <a href="{{ route('admin.submissions.srf') }}" class="inline-flex items-center px-3 py-2 text-xs font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <form action="{{ route('admin.submissions.status.update', ['type' => 'srf', 'id' => $submission->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-4">
