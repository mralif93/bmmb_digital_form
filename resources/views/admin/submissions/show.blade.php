...
<div class="mb-4 p-3 bg-red-100 dark:bg-red-900/30 border border-red-300 dark:border-red-700 rounded-lg text-sm text-red-800 dark:text-red-400 flex items-center">
    ...
    <div>
        ...
        <p class="text-xs mt-1">Deleted on {{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->deleted_at)->format($dateFormat . ' ' . $timeFormat) }}</p>
    </div>
</div>
@endif
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                    ...
                    <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                        {{ $submission->submitted_at ? \App\Helpers\TimezoneHelper::toSystemTimezone($submission->submitted_at)->format($dateFormat . ' ' . $timeFormat) : 'Not submitted' }}
                    </dd>
                </div>
                <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                    <dt class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider flex-shrink-0 w-1/3">
                    ...
                    <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                        {{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->created_at)->format($dateFormat . ' ' . $timeFormat) }}
                    </dd>
                </div>
                ...
                <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                    ...
                    <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                        ...
                        <span class="text-gray-500 dark:text-gray-400 text-xs block mt-1">on {{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->taken_up_at)->format($dateFormat . ' ' . $timeFormat) }}</span>
                    </dd>
                </div>
                @endif
                ...
                <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                    ...
                    <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                        ...
                        <span class="text-gray-500 dark:text-gray-400 text-xs block mt-1">on {{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->completed_at)->format($dateFormat . ' ' . $timeFormat) }}</span>
                    </dd>
                </div>
                @endif
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-start border-b border-gray-200 dark:border-gray-700 pb-3 last:border-0 gap-4">
                    ...
                    <dd class="text-sm text-gray-900 dark:text-white flex-1 text-left">
                        {{ $submission->reviewedBy->first_name . ' ' . $submission->reviewedBy->last_name }} on {{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->reviewed_at)->format($dateFormat . ' ' . $timeFormat) }}
                    </dd>
                </div>
                @endif
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start border-b border-amber-200 dark:border-amber-800 pb-2 gap-4">
                        ...
                        <dd class="text-sm text-gray-900 dark:text-white flex-1">
                            {{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->acknowledgment_date_received)->format($dateFormat) }}
                        </dd>
                    </div>
                    @endif
            ...
            <div class="{{ $submission->acknowledgment_received_by ? 'pt-4 border-t border-amber-300 dark:border-amber-700' : '' }}">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-start border-b border-amber-200 dark:border-amber-800 pb-2 gap-4">
                        ...
                        <dd class="text-sm text-gray-900 dark:text-white flex-1">
                            {{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->verification_date)->format($dateFormat) }}
                        </dd>
                    </div>
                    @endif
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <dl class="space-y-2 text-xs">
                ...
                <div>
                    ...
                    <dd class="text-gray-900 dark:text-white">{{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->started_at)->format($dateFormat . ' ' . $timeFormat) }}</dd>
                </div>
                @endif
                @if($submission->last_modified_at)
                <div>
                    <dt class="text-gray-500 dark:text-gray-400">Last Modified</dt>
                    <dd class="text-gray-900 dark:text-white">{{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->last_modified_at)->format($dateFormat . ' ' . $timeFormat) }}</dd>
                </div>
                @endif
            </dl>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <dl class="space-y-2 text-xs">
                ...
                <div>
                    ...
                    <dd class="text-gray-900 dark:text-white">{{ \App\Helpers\TimezoneHelper::toSystemTimezone($submission->submitted_at)->format($dateFormat . ' ' . $timeFormat) }}</dd>
                </div>
                @endif
            </dl>
        </div>
