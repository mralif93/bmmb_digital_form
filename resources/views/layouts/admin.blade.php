...
<body class="font-sans">
    <!-- Row 1: Header -->
    <header class="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md shadow-lg border-b border-gray-200 dark:border-gray-700">
        <div class="px-6 py-4">
    ...
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <div class="w-56 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md shadow-lg border-r border-gray-200 dark:border-gray-700">
            <!-- Navigation -->
            <nav class="p-4 space-y-1">
                ...
                <div class="mb-8">
                    <div class="space-y-0.5">
                        ...
                        <a href="{{ route('admin.users') }}" class="flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-300 rounded-md hover:bg-orange-50 dark:hover:bg-orange-900/20 hover:text-orange-600 dark:hover:text-orange-400 transition-colors {{ request()->routeIs('admin.users*') ? 'bg-orange-50 dark:bg-orange-900/20 text-orange-600 dark:text-orange-400' : '' }}">
                ...
                <div class="px-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex items-center space-x-3">
                                <a href="#" class="text-xs text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">Privacy Policy</a>
                                <a href="#" class="text-xs text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">Terms of Service</a>
                                <a href="#" class="text-xs text-gray-600 dark:text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">Support</a>
                            </div>
                        </div>
