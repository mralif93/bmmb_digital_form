...
@section('title', 'Redirecting to MAP - BMMB Digital Forms')
                ...
                <div
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 text-sm">
                            Connecting to MAP Authentication...
                        </p>
                    </div>
                    ...
                    <div class="space-y-3">
                        @php
                            // Get MAP redirect URL from config or construct from MAP_BASE_URL
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="text-left">
                                ...
                                <p class="text-xs text-gray-700 dark:text-gray-300">
                                    You are being redirected to MAP for authentication. If you are already logged in to MAP,
                                    you will be automatically logged in here.
                                </p>
                            </div>
                        </div>
                    </div>
